...
import { userValidator, userRegisterValidator } from '../validator/user-validator'
...
export default class UserRouter {
  ...
  initializeRoutes() {
    ...
    this.router.post('/', userRegisterValidator, requestbodyValidator, userControllers.insert);
